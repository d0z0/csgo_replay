...
# Message Classes
#
class GameServerPing < ::Protobuf::Message; end
class DetailedSearchStatistic < ::Protobuf::Message; end
class TournamentPlayer < ::Protobuf::Message; end
class TournamentTeam < ::Protobuf::Message; end
class TournamentEvent < ::Protobuf::Message; end
class GlobalStatistics < ::Protobuf::Message; end
class OperationalStatisticDescription < ::Protobuf::Message; end
class OperationalStatisticElement < ::Protobuf::Message; end
class OperationalStatisticsPacket < ::Protobuf::Message; end
class PlayerRankingInfo < ::Protobuf::Message; end
class PlayerCommendationInfo < ::Protobuf::Message; end
class PlayerMedalsInfo < ::Protobuf::Message; end
class AccountActivity < ::Protobuf::Message; end
class TournamentMatchSetup < ::Protobuf::Message; end
class ServerHltvInfo < ::Protobuf::Message; end
class IpAddressMask < ::Protobuf::Message; end
class XpProgressData < ::Protobuf::Message; end
class MatchEndItemUpdates < ::Protobuf::Message; end
class PlayerQuestData < ::Protobuf::Message
  class QuestItemData < ::Protobuf::Message; end

end

class CMsgGC_ServerQuestUpdateData < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_MatchmakingGCOperationalStats < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_MatchmakingGC2ServerConfirm < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_GC2ServerReservationUpdate < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_MatchmakingStart < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_MatchmakingStop < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_MatchmakingClient2ServerPing < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_MatchmakingGC2ClientUpdate < ::Protobuf::Message
  class Note < ::Protobuf::Message; end

end

class CDataGCCStrike15_v2_TournamentMatchDraft < ::Protobuf::Message
  class Entry < ::Protobuf::Message; end

end

class CPreMatchInfoData < ::Protobuf::Message
  class TeamStats < ::Protobuf::Message; end

end

class CMsgGCCStrike15_v2_MatchmakingGC2ServerReserve < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_MatchmakingServerReservationResponse < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_MatchmakingGC2ClientReserve < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_MatchmakingServerRoundStats < ::Protobuf::Message
  class DropInfo < ::Protobuf::Message; end

end

class CMsgGCCStrike15_v2_MatchmakingServerMatchEnd < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_MatchmakingClient2GCHello < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_MatchmakingGC2ClientHello < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_AccountPrivacySettings < ::Protobuf::Message
  class Setting < ::Protobuf::Message; end

end

class CMsgGCCStrike15_v2_MatchmakingGC2ClientAbandon < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_MatchmakingServer2GCKick < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_MatchmakingGC2ServerRankUpdate < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_MatchmakingOperator2GCBlogUpdate < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_ServerNotificationForUserPenalty < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_ClientReportPlayer < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_ClientCommendPlayer < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_ClientReportServer < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_ClientReportResponse < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_ClientRequestWatchInfoFriends < ::Protobuf::Message; end
class WatchableMatchInfo < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_ClientRequestJoinFriendData < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_ClientRequestJoinServerData < ::Protobuf::Message; end
class CMsgGCCstrike15_v2_ClientRequestNewMission < ::Protobuf::Message; end
class CMsgGCCstrike15_v2_GC2ServerNotifyXPRewarded < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_WatchInfoUsers < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_ClientRequestPlayersProfile < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_PlayersProfile < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_PlayerOverwatchCaseUpdate < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_PlayerOverwatchCaseAssignment < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_PlayerOverwatchCaseStatus < ::Protobuf::Message; end
class CClientHeaderOverwatchEvidence < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_GC2ClientTextMsg < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_Client2GCTextMsg < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_MatchEndRunRewardDrops < ::Protobuf::Message; end
class CEconItemPreviewDataBlock < ::Protobuf::Message
  class Sticker < ::Protobuf::Message; end

end

class CMsgGCCStrike15_v2_MatchEndRewardDropsNotification < ::Protobuf::Message; end
class CMsgItemAcknowledged < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_Client2GCEconPreviewDataBlockRequest < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_Client2GCEconPreviewDataBlockResponse < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_TournamentMatchRewardDropsNotification < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_MatchListRequestCurrentLiveGames < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_MatchListRequestLiveGameForUser < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_MatchListRequestRecentUserGames < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_MatchListRequestTournamentGames < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_MatchListRequestFullGameInfo < ::Protobuf::Message; end
class CDataGCCStrike15_v2_MatchInfo < ::Protobuf::Message; end
class CDataGCCStrike15_v2_TournamentGroupTeam < ::Protobuf::Message; end
class CDataGCCStrike15_v2_TournamentGroup < ::Protobuf::Message
  class Picks < ::Protobuf::Message; end

end

class CDataGCCStrike15_v2_TournamentSection < ::Protobuf::Message; end
class CDataGCCStrike15_v2_TournamentInfo < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_MatchList < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_Predictions < ::Protobuf::Message
  class GroupMatchTeamPick < ::Protobuf::Message; end

end

class CMsgGCCStrike15_v2_Fantasy < ::Protobuf::Message
  class FantasySlot < ::Protobuf::Message; end
  class FantasyTeam < ::Protobuf::Message; end

end

class CAttribute_String < ::Protobuf::Message; end
class CMsgGCToGCReloadVersions < ::Protobuf::Message; end
class CMsgCStrike15Welcome < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_ClientVarValueNotificationInfo < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_ServerVarValueNotificationInfo < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_GiftsLeaderboardRequest < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_GiftsLeaderboardResponse < ::Protobuf::Message
  class GiftLeaderboardEntry < ::Protobuf::Message; end

end

class CMsgGCCStrike15_v2_ClientSubmitSurveyVote < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_Server2GCClientValidate < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_Server2GCPureServerValidationFailure < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_GC2ClientTournamentInfo < ::Protobuf::Message; end
class CSOEconCoupon < ::Protobuf::Message; end
class CSOQuestProgress < ::Protobuf::Message; end
class CSOPersonaDataPublic < ::Protobuf::Message; end
class CMsgGC_GlobalGame_Subscribe < ::Protobuf::Message; end
class CMsgGC_GlobalGame_Unsubscribe < ::Protobuf::Message; end
class CMsgGC_GlobalGame_Play < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_AcknowledgePenalty < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_Client2GCRequestPrestigeCoin < ::Protobuf::Message; end
class CMsgGCCStrike15_v2_Client2GCStreamUnlock < ::Protobuf::Message; end
